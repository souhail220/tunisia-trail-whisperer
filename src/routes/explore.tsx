...
export const Route = createFileRoute("/explore")({
  ...
  component: ExploreWrap,
});

function ExploreWrap() { return <ShellExplore />; }

function ShellExplore() {
  return (
            ...
            <div key={g.id} className="bg-card rounded-2xl p-4 shadow-[var(--shadow-card)] flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1">
                  ...
                  {g.verified && <BadgeCheck className="h-4 w-4 text-primary fill-primary/15" />}
                </div>
